>QMetaType и QVariant::Type **оба являются перечислениями (enum class в )**, которое описывало возможные типы данных, которые может хранить `QVariant`. Но с ключевыми отличиями в архитектуре.
___

**QVariant::Type (устаревший в Qt6)** 
```cpp
